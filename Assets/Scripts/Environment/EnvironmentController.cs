...
{
    [SerializeField] private List<EnvironmentData> _tiles;
    
    private InteractableController _interactableMover;
    ...
    public void Init()
    {
        ...
        _interactableMover = ServiceLocator.Current.Get<InteractableController>();
    }
